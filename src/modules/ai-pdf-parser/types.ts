...
export interface AIRawResponse {
  header: {
    ...
    totalXp: number;
    totalUxp: number;
    exportDate: string; // Can be YYYY-MM-DD or "9 nov 2025" format
  };
...
export interface AIRawFlight {
  ...
  postingDate: string; // Can be various formats
  ...
  flightDate: string; // Can be various formats
...
export interface AIRawMilesActivity {
  ...
  date: string; // Can be various formats
